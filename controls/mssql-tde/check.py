#!/usr/bin/env python3
"""Control: mssql-tde — Ensure Databases are Encrypted with TDE"""
...
QUERY = """SELECT d.name, d.is_encrypted FROM sys.databases d WHERE d.database_id > 4 AND d.is_encrypted = 0;"""
