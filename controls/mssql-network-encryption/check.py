#!/usr/bin/env python3
"""Control: mssql-network-encryption — Ensure Network Encryption is Configured and Enabled"""
...
QUERY = """SELECT DISTINCT CAST(encrypt_option AS varchar(10)) AS encrypt_option FROM sys.dm_exec_connections c WHERE net_transport <> 'Shared memory' AND c.endpoint_id NOT IN (SELECT endpoint_id FROM sys.database_mirroring_endpoints WHERE encryption_algorithm IS NOT NULL);"""

ASSERTIONS = [
    ("encrypt_option", "equals", "TRUE"),
]
