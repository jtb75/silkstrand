#!/usr/bin/env python3
"""Control: mssql-guest-connect-revoked — Ensure CONNECT permissions on guest user is Revoked"""
...
QUERY = """SELECT DB_NAME() AS database_name, 'guest' AS grantee, permission_name FROM sys.database_permissions WHERE grantee_principal_id = DATABASE_PRINCIPAL_ID('guest') AND permission_name = 'CONNECT' AND state_desc = 'GRANT';"""
