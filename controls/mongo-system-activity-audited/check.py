#!/usr/bin/env python3
"""Control: mongo-system-activity-audited — Ensure that system activity is audited"""
...
CONTROL_ID = "mongo-system-activity-audited"
...
ASSERTIONS = [
    ("parsed.auditLog.destination", "exists", True),
]
