#!/usr/bin/env python3
"""Control: mongo-tls-transport-encryption — Ensure Encryption of Data in Transit TLS/SSL"""
...
CONTROL_ID = "mongo-tls-transport-encryption"
...
ASSERTIONS = [
    ("parsed.net.tls.mode", "equals", "requireTLS"),
]
