#!/usr/bin/env python3
"""Control: mssql-non-standard-port — Ensure SQL Server is configured to use non-standard ports"""
...
QUERY = """SELECT DISTINCT local_tcp_port FROM sys.dm_exec_connections WHERE local_tcp_port IS NOT NULL;"""

ASSERTIONS = [
    ("value", "not_equals", "1433"),
]
