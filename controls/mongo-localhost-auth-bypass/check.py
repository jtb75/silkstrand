#!/usr/bin/env python3
"""Control: mongo-localhost-auth-bypass — Ensure MongoDB does not bypass authentication via localhost exception"""
...
CONTROL_ID = "mongo-localhost-auth-bypass"
TITLE = "Ensure MongoDB does not bypass authentication via localhost exception"
SEVERITY = "high"
DB_NAME = "admin"
COMMAND = {'getCmdLineOpts': 1}

ASSERTIONS = [
    ("parsed.setParameter.enableLocalhostAuthBypass", "equals", False),
]
