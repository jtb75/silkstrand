#!/usr/bin/env python3
"""Control: mongo-log-append — Ensure that new entries are appended to the end of the log file"""
...
ASSERTIONS = [
    ("parsed.systemLog.logAppend", "equals", True),
]
