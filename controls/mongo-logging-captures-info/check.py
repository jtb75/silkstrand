#!/usr/bin/env python3
"""Control: mongo-logging-captures-info — Ensure that logging captures as much information as possible"""
...
CONTROL_ID = "mongo-logging-captures-info"
...
ASSERTIONS = [
    ("logLevel", "greater_than_or_equal", "0"),
]
