#!/usr/bin/env python3
"""Control: mssql-backup-encryption — Ensure Database Backups are Encrypted"""
...
QUERY = """SELECT bs.database_name, bs.backup_finish_date, bs.key_algorithm FROM msdb.dbo.backupset bs WHERE bs.type = 'D' AND bs.key_algorithm IS NULL AND bs.backup_finish_date >= DATEADD(day, -30, GETDATE());"""
