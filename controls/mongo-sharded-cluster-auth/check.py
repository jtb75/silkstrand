#!/usr/bin/env python3
"""Control: mongo-sharded-cluster-auth — Ensure authentication is enabled in the sharded cluster"""
...
CONTROL_ID = "mongo-sharded-cluster-auth"
...
ASSERTIONS = [
    ("parsed.security.clusterAuthMode", "equals", "x509"),
]
