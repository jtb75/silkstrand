#!/usr/bin/env python3
"""Control: mongo-weak-protocols-disabled — Ensure Weak Protocols are Disabled"""
...
CONTROL_ID = "mongo-weak-protocols-disabled"
...
ASSERTIONS = [
    ("parsed.net.tls.disabledProtocols", "contains", "TLS1_0"),
]
