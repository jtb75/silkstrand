#!/usr/bin/env python3
"""Control: mssql-audit-logins — Ensure SQL Server Audit captures both failed and successful logins"""
...
QUERY = """SELECT CAST(SERVERPROPERTY('AuditLevel') AS int) AS AuditLevel;"""
