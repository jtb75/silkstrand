#!/usr/bin/env python3
"""Control: mssql-hide-instance — Ensure Hide Instance option is set to Yes"""
...
QUERY = r"""DECLARE @getValue INT; EXEC master.sys.xp_instance_regread @rootkey = N'HKEY_LOCAL_MACHINE', @key = N'SOFTWARE\Microsoft\Microsoft SQL Server\MSSQLServer\SuperSocketNetLib', @value_name = N'HideInstance', @value = @getValue OUTPUT; SELECT @getValue AS hide_instance;"""
