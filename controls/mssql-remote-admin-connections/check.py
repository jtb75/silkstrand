#!/usr/bin/env python3
"""Control: mssql-remote-admin-connections — Ensure Remote Admin Connections is set to 0"""
...
QUERY = """SELECT name, CAST(value AS int) AS value_configured, CAST(value_in_use AS int) AS value_in_use FROM sys.configurations WHERE name = 'remote admin connections';"""
