#!/usr/bin/env python3
"""Control: mongo-fips-enabled — Ensure Federal Information Processing Standard (FIPS) is enabled"""
...
ASSERTIONS = [
    ("parsed.net.tls.FIPSMode", "equals", True),
]
